	...
	public class StudentEntityBase extends EventDispatcher {
		...
		flextrine function saveState():void {
			if (isInitialized__) {
				...
				flextrine::savedState["country"] = country;
				marks.flextrine::saveState();
			}
		}
		...
		flextrine function restoreState():void {
			if (isInitialized__) {
				...
				country = flextrine::savedState["country"]; // this will trigger bi-directional??
				marks.flextrine::restoreState();
			}
		}
