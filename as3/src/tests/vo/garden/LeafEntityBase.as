package tests.vo.garden {
	...
	public class LeafEntityBase extends EventDispatcher {
		...
		public function set branch(value:Branch):void { (value) ? value.flextrine::addValue('leaves', this) : ((_branch) ? _branch.flextrine::removeValue('leaves', this) : null); _branch = value; }
